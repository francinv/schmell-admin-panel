    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('D', 'Development'), ('R', 'Ready'), ('P', 'Deployed')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_week', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminAPI.weekgame')),
            ],
        ),
        migrations.CreateModel(
            name='Account',
